...
echo "puts 'starting addresses'" >> db/seeds.rb
LCCMF/create.pl -t Address      -h < LCCMF/addresses.tab	>> db/seeds.rb
echo "puts 'starting accomodations'" >> db/seeds.rb
LCCMF/create.pl -t Accomodation -h < LCCMF/accomodations.tab	>> db/seeds.rb

...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { arranger: @piece.arranger, composer_id: @piece.composer_id, full_title: @piece.full_title, name: @piece.name, opus: @piece.opus, year_composed: @piece.year_composed } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { arranger: @piece.arranger, composer_id: @piece.composer_id, full_title: @piece.full_title, name: @piece.name, opus: @piece.opus, year_composed: @piece.year_composed } }

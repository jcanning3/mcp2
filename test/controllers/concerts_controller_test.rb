...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { location: @concert.location, name: @concert.name, startTime: @concert.startTime } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { location: @concert.location, name: @concert.name, startTime: @concert.startTime } }

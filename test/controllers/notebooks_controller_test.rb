...
class NotebooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notebook" do
    assert_difference('Notebook.count') do
      post notebooks_url, params: { notebook: { message: @notebook.message, notebook_id: @notebook.notebook_id, notebook_type: @notebook.notebook_type } }
    end
  ...
  test "should update notebook" do
    patch notebook_url(@notebook), params: { notebook: { message: @notebook.message, notebook_id: @notebook.notebook_id, notebook_type: @notebook.notebook_type } }

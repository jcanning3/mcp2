...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post performances_url, params: { performance: { concert_id: @performance.concert_id, order: @performance.order, piece_id: @performance.piece_id } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { concert_id: @performance.concert_id, order: @performance.order, piece_id: @performance.piece_id } }

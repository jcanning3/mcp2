...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { event_id: @assignment.event_id, name: @assignment.name, task_id: @assignment.task_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { event_id: @assignment.event_id, name: @assignment.name, task_id: @assignment.task_id } }

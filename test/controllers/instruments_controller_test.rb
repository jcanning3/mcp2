...
class InstrumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instrument" do
    assert_difference('Instrument.count') do
      post instruments_url, params: { instrument: { name: @instrument.name, order: @instrument.order } }
    end
  ...
  test "should update instrument" do
    patch instrument_url(@instrument), params: { instrument: { name: @instrument.name, order: @instrument.order } }

...
class SheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sheet" do
    assert_difference('Sheet.count') do
      post sheets_url, params: { sheet: { note: @sheet.note, pad_id: @sheet.pad_id, pad_type: @sheet.pad_type } }
    end
  ...
  test "should update sheet" do
    patch sheet_url(@sheet), params: { sheet: { note: @sheet.note, pad_id: @sheet.pad_id, pad_type: @sheet.pad_type } }

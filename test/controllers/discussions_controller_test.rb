...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { color: @discussion.color, date: @discussion.date, resolved: @discussion.resolved } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { color: @discussion.color, date: @discussion.date, resolved: @discussion.resolved } }

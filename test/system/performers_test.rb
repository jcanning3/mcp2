...
class PerformersTest < ApplicationSystemTestCase
  ...
  test "creating a Performer" do
    ...
    fill_in "Concert Date", with: @performer.concert_date
    fill_in "Concert", with: @performer.concert_id
    fill_in "Instrument", with: @performer.instrument
    fill_in "Listing", with: @performer.listing
    fill_in "Musician", with: @performer.musician_id
    fill_in "Order", with: @performer.order
    fill_in "Piece", with: @performer.piece_id
